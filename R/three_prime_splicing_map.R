...
#' boundaries of 3' Exon events and renders the two-region splicing
#' map.
#'
...
#' @export
three_prime_splicing_map <- function(events, bed_file,
                                          opts  = splicing_options(),
                                          style = splicing_style(),
                                          title = "") {
  #Wraps Error's thrown
  wrap_sm_errors("3' splicing map", {
