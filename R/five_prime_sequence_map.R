...
#'  5' Exon events and renders the two-region sequence map.
#'
...
#' @export
five_prime_sequence_map <- function(events, sequence,
                                          genome     = NULL,
