...
window spanning the exon-intron junctions of skipped-exon (SE)
alternative splicing events from rMATS output.
...
A per-bin moving average is applied to reduce positional noise. Adjust
the window size or disable smoothing:
...
forms the control ribbon on the plot.
