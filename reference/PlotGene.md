...
- bed:
  ...
  A data frame containing BED-format peak data. Must have at least
...
- merge:
  ...
  Minimum gap width (bp) for merging nearby peaks. Default 0 (no
  merging).
...
- total_arrows:
  ...
  indicate transcription direction. Default is 6.
...
- five_to_three:
  ...
  Logical. If TRUE, orients the plot so that 5' is on the left and 3' is
