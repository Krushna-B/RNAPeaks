# RNAPeaks ![](reference/figures/logo.png)

**Publication-quality visualization of RNA-binding protein peaks on gene
structures**
...
[![License:
MIT](https://img.shields.io/badge/License-MIT-blue.svg)](https://krushna-b.github.io/RNAPeaks/LICENSE)
...
Splicing map and sequence motif analyses quantify position-specific
binding frequency around splice junctions with bootstrap-based
...
Full function reference and articles are available at the package
website:
...
| Feature                                          | Function                                                                                     |
|--------------------------------------------------|----------------------------------------------------------------------------------------------|
| Single-gene RBP peak visualization               | [`PlotGene()`](https://krushna-b.github.io/RNAPeaks/reference/PlotGene.md)                   |
...
- Bootstrap-based z-score significance testing for enriched binding
  regions
...
to validate and normalize your file before plotting.
...
provide the `SE.MATS.JC.txt` output from
...
`IncLevelDifference`, `IJC_SAMPLE_1`, `SJC_SAMPLE_1`, `IJC_SAMPLE_2`,
...
tracker](https://github.com/Krushna-B/RNAPeaks/issues).
...
MIT License — see
[LICENSE](https://krushna-b.github.io/RNAPeaks/LICENSE) for details.
